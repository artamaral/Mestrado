...
class readJSON():
    ...
    def loadJSON(self):
        ...
        image_folder = Path("C:/Users/aoliveir/Documents/images")
        ...
        #path2File = data_folder / "testbdd2.json"
        print(path2File)
        ...
        with open(path2File, mode='r') as read_file:
            ...
            for annotation in annotations:
                ...
                #get img data
                #height, width = dataJSON.loadIMG(str(annotation["name"]))
                    
                #save img path to txt
                path2image = image_folder / annotation["name"]
                dataJSON.writeTXT_train(path2image)
                dataJSON.write_TXTtoPD_filename(str(path2image))
                    ...
                    if 'box2d' not in annotation_labels:
                        ...
                        for polys in annotation_labels["poly2d"]:
                            ...
                            #print(str(annotation["name"])+',',str(annotation_labels["category"])+',', str(obj_Xcenter) + ',' ,str(obj_Ycenter)+ ',' ,str(obj_width)+ ',' ,str(obj_height)) 
                                ...
                                img_Data2 = str(int(x1)) + "," + str(int(y1))+ "," + str(int(x2))+ "," + str(int(y2)) + "," + typeOF  
                                #print(img_Data2)
                                dataJSON.write_TXTtoPD_filename(str(img_Data2 + " "))
                ...
                print("E o enter??????")    
                dataJSON.write_TXTtoPD_filename("\n")
    ...
    def write_TXTtoPD_filename(self,path2image):
        
              
        with open("train2.txt", mode='a') as filewriter:
